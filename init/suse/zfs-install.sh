...
zypper --non-interactive install --no-recommends rpm zypper openSUSE-release kernel-default makedev sudo nano less grub2 grub2-x86_64-efi shim efibootmgr firewalld openssl kernel-devel
